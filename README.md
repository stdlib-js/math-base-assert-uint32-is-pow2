...
```javascript
import isPow2Uint32 from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-assert-uint32-is-pow2@v0.2.1-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/math-base-assert-uint32-is-pow2/actions/workflows/test.yml/badge.svg?branch=v0.2.1
[test-url]: https://github.com/stdlib-js/math-base-assert-uint32-is-pow2/actions/workflows/test.yml?query=branch:v0.2.1
