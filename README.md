...
```javascript
isPow2Uint32 = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-assert-uint32-is-pow2@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/math-base-assert-uint32-is-pow2@umd/bundle.js"></script>
```
